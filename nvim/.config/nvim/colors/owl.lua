...
hi("PreProc", { fg = c.muted })
hi("Include", { fg = c.muted })
hi("Define", { fg = c.muted })
hi("Macro", { fg = c.muted })
hi("PreCondit", { fg = c.muted })
hi("Type", { fg = c.fg_soft })
hi("StorageClass", { fg = c.fg_soft })
hi("Structure", { fg = c.fg_soft })
hi("Typedef", { fg = c.fg_soft })
hi("Special", { fg = c.muted })
hi("SpecialChar", { fg = c.muted })
hi("Tag", { fg = c.muted })
...
hi("@keyword.return", { fg = c.fg_soft })
